    ...
    <div class="px-4 sm:px-0 max-w-4xl">
        ...
        <div class="space-y-6">
            <div class="rounded-lg border bg-white p-4">
                <h2 class="text-sm font-semibold text-gray-900">{{ __('admin.geo_eval.insight_eeat') }}</h2>
                <p class="mt-2 text-2xl font-semibold">{{ $template->eeat_score ?? '—' }}</p>
            </div>
            <div class="rounded-lg border bg-white p-4">
                <h2 class="text-sm font-semibold text-gray-900">{{ __('admin.geo_eval.insight_features') }}</h2>
            ...
            <div class="rounded-lg border bg-white p-4">
                <h2 class="text-sm font-semibold text-gray-900">StyleGuide</h2>
