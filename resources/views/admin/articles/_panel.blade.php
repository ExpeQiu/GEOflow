@php
    ...
    $reviewCenterUrl = route('admin.operations.index', ['tab' => 'articles', 'review_status' => 'pending']);
    $trashUrl = route('admin.operations.index', ['tab' => 'articles', 'trashed' => 1]);
    $articlesIndexUrl = route('admin.operations.index', ['tab' => 'articles']);
    $clearTaskFilterUrl = route('admin.operations.index', array_merge(['tab' => 'articles'], request()->except(['task_id', 'page'])));
@endphp

<div class="mb-8 @unless($standalone ?? false) flex items-center justify-between @else flex justify-end @endunless">
                ...
                <form method="GET" class="space-y-4">
                    ...
                    <div class="flex items-end space-x-4">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ $isTrashView ? route('admin.operations.index', ['tab' => 'articles', 'trashed' => 1]) : $articlesIndexUrl }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
