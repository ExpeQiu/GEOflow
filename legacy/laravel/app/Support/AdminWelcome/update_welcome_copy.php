...
return static function (array $welcomeState): array {
    ...
    return [
        'zh-CN' => [
            ...
            'letter' => [
                'title' => 'GEOworkflow 有新版本可更新',
                'subtitle' => '当前版本 v'.$currentVersion.'，最新版本 v'.$latestVersion.'。',
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleZh !== '' ? $titleZh : '后台已经检测到 GEOworkflow 上游仓库有一个新版本可用。',
                    ],
                    [
                        'type' => 'paragraph',
        ...
        'en' => [
            ...
            'letter' => [
                'title' => 'A new GEOworkflow version is available',
                'subtitle' => 'Current version v'.$currentVersion.', latest version v'.$latestVersion.'.',
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleEn !== '' ? $titleEn : 'The admin has detected that a newer GEOworkflow release is available in the upstream repository.',
                    ],
                    [
                        'type' => 'paragraph',
