...
class Task extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'tech_ip_asset_id' => 'integer',
        ];
    }

    public function isWikiMdx(): bool
    {
        return (string) ($this->content_format ?? 'article') === 'wiki_mdx';
    }

    public function techIpAsset(): BelongsTo
    {
        return $this->belongsTo(TechIpAsset::class, 'tech_ip_asset_id');
    }
