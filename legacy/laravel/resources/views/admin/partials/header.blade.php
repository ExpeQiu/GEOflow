@php
    ...
    $menuGroups = [
        'l2' => ['label' => __('admin.nav.group_production'), 'items' => [
            ...
            'tech_assets' => ['route' => 'admin.tech-assets.index', 'name' => __('admin.nav.tech_assets')],
        ]],
    ...
    $subMap = [
        ...
        'admin.tech-assets.index' => 'production_hub',
        'admin.tech-assets.create' => 'production_hub',
        'admin.tech-assets.store' => 'production_hub',
        'admin.tech-assets.edit' => 'production_hub',
        'admin.tech-assets.update' => 'production_hub',
        'admin.tech-assets.import' => 'production_hub',
