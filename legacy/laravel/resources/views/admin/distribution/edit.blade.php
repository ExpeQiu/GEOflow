...
@php
    ...
    $gwebConfig = $channel->resolvedGwebConfig();
                    ...
                    @elseif ($channel->isGwebWiki())
                        <div class="rounded-lg border border-teal-100 bg-teal-50 p-5">
                            <div class="mb-5">
                                ...
                                <p class="mt-1 text-sm leading-6 text-gray-600">{{ __('admin.distribution.gweb.edit_section_desc') }}</p>
                            </div>
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    <label for="gweb_sync_secret" class="block text-sm font-medium text-gray-700">{{ __('admin.distribution.gweb.sync_secret') }}</label>
                                    <input id="gweb_sync_secret" name="gweb_sync_secret" type="password" value="{{ old('gweb_sync_secret') }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500" autocomplete="new-password" placeholder="{{ __('admin.distribution.gweb.sync_secret_placeholder') }}">
                                ...
                                <div>
                                    ...
                                    <input id="gweb_timeout_seconds" name="gweb_timeout_seconds" type="number" min="5" max="120" value="{{ old('gweb_timeout_seconds', $gwebConfig['timeout_seconds']) }}" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                </div>
                            </div>
