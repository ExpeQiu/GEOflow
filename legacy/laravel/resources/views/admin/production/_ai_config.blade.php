<section class="mb-6 overflow-hidden rounded-lg border border-violet-200 bg-white shadow-sm">
    ...
    <div class="grid grid-cols-1 gap-6 p-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        ...
        <div class="overflow-hidden rounded-lg border border-slate-300 bg-slate-50">
            <div class="p-6">
                <div class="flex items-center">
                    <div class="flex h-10 w-10 items-center justify-center rounded-md bg-slate-700">
                        <i data-lucide="workflow" class="h-5 w-5 text-white"></i>
                    </div>
                    <div class="ml-4 min-w-0">
                        <p class="text-sm font-medium text-gray-500">{{ __('admin.ai_configurator.orchestration_title') }}</p>
                        <p class="mt-1 text-base font-semibold text-gray-900">{{ __('admin.ai_configurator.orchestration_card_desc') }}</p>
                    </div>
                </div>
            </div>
            <div class="border-t border-gray-100 bg-gray-50 px-6 py-3">
                <a href="#content-agent-orchestration" class="text-sm font-medium text-slate-700 hover:text-slate-900">
                    {{ __('admin.ai_configurator.orchestration_action') }} <span aria-hidden="true">&rarr;</span>
                </a>
            </div>
        </div>
    </div>
...
@include('admin.production._orchestration_panel', [
    ...
    'orchestrationPanelId' => 'content-agent-orchestration',
])
